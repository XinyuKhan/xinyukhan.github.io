...
$$
\begin{aligned}
\hat J_i &= \min_{u_i}{\{\ell(x_i,u_i)+\hat J_{i+1}\}}\\
...
$$
\begin{aligned}
\hat J_{N-1} &= \min_{u_{N-1}}{\{\ell(x_{N-1},u_{N-1})+\hat J_N(x_N)\}}\\
&= \min_{u_{N-1}}{\{\ell(x_{N-1},u_{N-1})+\hat J_N(f(x_{N-1},u_{N-1}))\}}\\
&=\min_{u_{N-1}}{\tilde J_{N-1}(x_{N-1},u_{N-1})}\\
&=\hat J_{N-1}(x_{N-1})
\end{aligned}
\tag{4}
$$
