...
$$
\min_{u_{N-1}}{J}=\min_{u_{N-1}}{\{J_{N-1}+J_{N-1}^{\prime}\}} \tag{5}
$$
...
$$
\begin{aligned} 
\min_{u_{N-1}}{J}&=J_{N-1}^{\prime}+\min_{u_{N-1}}{J_{N-1}}\\ 
&=J_{N-1}^{\prime}+\min_{u_{N-1}}{\{\frac{1}{2}[x_{N-1}^TQ_{N-1}x_{N-1}+u_{N-1}^TR_{N-1}u_{N-1}]+J_{N}\}} 
\end{aligned} 
\tag{6}
$$
...
$$
\begin{aligned} \underset{u_{N-2},u_{N-1}}\min{J}&=\underset{u_{N-2}}\min{\{J_{N-1}^{\prime}+\min_{u_{N-1}}{J_{N-1}}\}}\\ &=J_{N-2}^{\prime}+\underset{u_{N-2}}\min{\{\frac{1}{2}[x_{N-2}^TQ_{N-2}x_{N-2}+u_{N-2}^TR_{N-2}u_{N-2}]+\min_{u_{N-1}}{J_{N-1}}\}} \end{aligned} \tag{7}
$$

根据上述规律，我们定义：

$$
\begin{aligned} \hat{J}_i=\underset{u_i\cdots u_{N-1}}\min{J_i}&=\min_{u_i}{\{\frac{1}{2}[x_i^TQ_ix_i+u_i^TR_iu_i]+\underset{u_{i+1}\cdots u_{N-1}}\min{J_{i+1}}\}}\\ &=\min_{u_i}{\{\frac{1}{2}[x_i^TQ_ix_i+u_i^TR_iu_i]+\hat{J}_{i+1}\}} \end{aligned} \tag{8}
$$

现在我们考察 $\hat{J}_{N-1}$ 的具体形式：

$$
\begin{aligned} \hat{J}_{N-1}=\min_{u_{N-1}}{J_{N-1}}&=\min_{u_{N-1}}{\{\frac{1}{2}[x_{N-1}^TQ_{N-1}x_{N-1}+u_{N-1}^TR_{N-1}u_{N-1}]+J_{N}\}}\\ &=\min_{u_{N-1}}{\{\frac{1}{2}[x_{N-1}^TQ_{N-1}x_{N-1}+u_{N-1}^TR_{N-1}u_{N-1}]+\frac{1}{2}x_N^THx_N\}} \end{aligned} \tag{9}
$$
